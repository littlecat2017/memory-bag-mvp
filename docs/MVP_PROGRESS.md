...
| M8 MVP 美术接入 | 4% | 基本完成 | 4% | 更多角色/敌人/场景资源、特效表实际播放、UI 皮肤二次精修 | 资源路径稳定，图片生成有日志，不超过每日 50 张 |
...
- 让战斗事件不只是瞬时日志，至少能看到勇者侧/敌人侧站位、斩击特效和受击反馈。
- 打磨 Boss 战前后的视觉表现，让“忘名猎人”和“空名牌”更符合文档中的关系主题。
...
- 本日剩余可用额度：40 张，但下一轮优先做接入和抠图，不主动扩大生成量。
